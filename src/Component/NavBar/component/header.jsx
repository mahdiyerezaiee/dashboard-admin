...
const Header = () => {
    return (
        <div className="header">
            <Grid container>
                <Grid item xs={6} md={6} className="name">
                    <span> مهرناز عزیز، سلام!</span>
                </Grid>
                <Grid item xs={6} md={6} className="box">
                    <Search/>
...
<path fill-rule="evenodd" clip-rule="evenodd"
      ...
      stroke="#606060" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M14.2483 20.8574C12.9644 22.3721 10.9616 22.3901 9.66544 20.8574" stroke="#606060" stroke-width="1.5"
